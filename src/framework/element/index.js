...
/**
 * Overriding commands from WebdriverIO regarding Element handeling
...
module.exports = class Element {
  ...
  async getElementsCount(reverse = false) {
    Logger.info(`Get count of elements "${this.name}"`);
    await this.state().assertIsExist(timeouts.explicit, timeouts.polling, reverse);
    const elements = await await $$(this.locator);
